      ...
      <div className="py-14 sm:py-40">
        <div className="container text-center mx-auto max-w-7xl ">
          ...
          <div className="relative mt-6 max-h-[650px] overflow-hidden">
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/4 w-full bg-gradient-to-t from-[#1b263b] from-20% dark:from-black"></div>
            <div className="pointer-events-none absolute inset-x-0 top-0 h-1/4 w-full bg-gradient-to-b from-[#1b263b] from-20% dark:from-black"></div>
          </div>
        </div>
      </div>
    </section>
