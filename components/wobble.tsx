    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto mt-20 mb-20 w-full">
      ...
      >
        <div className="max-w-xs">
          ...
          <p className="mt-4 text-left  text-base/6 text-neutral-200">
            With over 100,000 mothly active users, Novaflow is the most popular
      ...
      <WobbleCard containerClassName="col-span-1 min-h-[300px] bg-[#415a77]">
        ...
        <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
          Just kidding, we love to talk about Novaflow. We are passionate about
          our platform and we love to share our passion with you.
        </p>
      </WobbleCard>
      <WobbleCard containerClassName="col-span-1 lg:col-span-3 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc]  min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
        <div className="max-w-sm">
          ...
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
            We utilize the latest in AI technology to bring you the most cutting
            edge solutions.
          </p>
        </div>
        <Image
