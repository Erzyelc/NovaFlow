        ...
        <div className="max-w-5xl mx-auto">
          <div className="pb-12 md:pb-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="text-4xl font-bold tracking-tight text-[#e0e1dd] sm:text-6xl">
                Our story (so far)
              </h2>
            </div>
              ...
              <div className="max-w-[548px] mx-auto">
                <div className="text-slate-400 space-y-6">
                  ...
                  <p>
                    ...
                    opportunities to innovate. It&apos;s a problem deeply
                    ingrained in traditional sectors like startups and the wider
                    service industry but which has been compounded in the past
                    five to ten years by the emergence of the mostly
                    tech-powered gig economy which has created a new generation
                    of shift workers and indeed
                  </p>
                </div>
              </div>
            </div>
