          ...
          <div className="mb-12 flex flex-col gap-4">
            <a href="/" className="flex items-center gap-2">
              <img
                ...
                alt="MagicUI Logo"
              />
              <span className="self-center whitespace-nowrap text-2xl font-semibold text-[#e0e1dd] dark:text-white">
                NovaFlow
              </span>
            </a>
            <div className="max-w-sm">
              <div className="z-10 mt-4 flex w-full flex-col items-start text-left">
                <h1 className="text-3xl font-bold text-gray-400 lg:text-2xl">
                  Get started today.
                </h1>
