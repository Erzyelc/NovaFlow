        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          ...
          <div className="flex flex-col gap-8">
            <p className="mt-10 text-center text-sm text-gray-400">
              ...
              <a
                href="/signup"
                className="font-semibold leading-6 text-gray-200 hover:text-gray-300"
              >
            ...
            <a
              href="/"
              className="mx-auto w-1/2 flex items-center justify-center rounded-md bg-[#415a77] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#415a77]/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400 "
            >
              Go Home
            </a>
          </div>
